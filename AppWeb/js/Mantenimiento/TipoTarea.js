...
function generarTabla(estado) {
    ...
    Mantenimientos.forEach((mantenimiento) => {
        if (estado == 'A') {
            ...
            btnNiveles.innerText = 'Tipo de Tarea  Inactivos'

                if(mantenimiento.estado == 'A'){
                    fila.innerHTML = `
                    <td>${mantenimiento.idTipoTarea}</td>  
                    <td>${mantenimiento.descripcion}</td>  
                    <td>
                        <button class="btn btnAzul btn-dark" onclick="abrirModalEditar(${mantenimiento.idTipoTarea})">Editar</button>
                        <button class="btn btnRojo btn-dark" onclick="EliminarMantenimiento(${mantenimiento.idTipoTarea})">Eliminar</button>
                    </td>
            ...
            btnNiveles.innerText = 'Tipo de Tarea Activos'
            ...
            if (mantenimiento.estado == 'I') {
                fila.innerHTML = `
                    ...
                    <td>${mantenimiento.descripcion}</td>  
                    <td>
                        <button class="btn btnRojo btn-dark" onclick="EliminarMantenimiento(${mantenimiento.idTipoTarea})">Reactivar Nivel</button>
                    </td>
...
function abrirModalEditar(id) {
    ...
    console.log(id);
    const mantenimiento = datosMantenimiento.find(item => item.idTipoTarea == id);
    console.log(mantenimiento);
    if (mantenimiento) {
        document.querySelector('input[name="idTipoTarea"]').value = mantenimiento.idTipoTarea;
