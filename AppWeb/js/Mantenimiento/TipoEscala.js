...
function generarTabla(estado) {
    ...
    Mantenimientos.forEach((mantenimiento) => {
        if (estado == 'A') {
            ...
            btnNiveles.innerText = 'Tipo de Escala  Inactivos'

                if(mantenimiento.estado == 'A'){
                    fila.innerHTML = `
                    <td>${mantenimiento.idTipoEscala}</td>  
                    <td>${mantenimiento.descripcion}</td>  
                    <td>
                        <button class="btn btnAzul btn-dark" onclick="abrirModalEditar(${mantenimiento.idTipoEscala})">Editar</button>
                        <button class="btn btnRojo btn-dark" onclick="EliminarMantenimiento(${mantenimiento.idTipoEscala})">Eliminar</button>
                    </td>
            ...
            btnNiveles.innerText = 'Tipo de Escala Activos'
            ...
            if (mantenimiento.estado == 'I') {
                fila.innerHTML = `
                    ...
                    <td>${mantenimiento.descripcion}</td>  
                    <td>
                        <button class="btn btnRojo btn-dark" onclick="EliminarMantenimiento(${mantenimiento.idTipoEscala})">Reactivar Escala</button>
                    </td>
...
function abrirModalEditar(id) {
    ...
    console.log(id);
    const mantenimiento = datosMantenimiento.find(item => item.idTipoEscala == id);
    console.log(mantenimiento);
    if (mantenimiento) {
        document.querySelector('input[name="idTipoEscala"]').value = mantenimiento.idTipoEscala;
        ...
        document.getElementById('tituloModal').innerText = 'Actualizar Tipo de Escala';
...
function abrirModalInsertar() {
    ...
    document.getElementById('tituloModal').innerText = 'Agregar  Tipo de Escala';
