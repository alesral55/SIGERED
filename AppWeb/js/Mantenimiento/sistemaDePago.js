...
function generarTabla(estado) {
    ...
    Mantenimientos.forEach((mantenimiento) => {
        if (estado == 'A') {
            ...
            btnNiveles.innerText = 'Sistema de Pago  Inactivos'

                if(mantenimiento.estado == 'A'){
                    fila.innerHTML = `
                    <td>${mantenimiento.idSistemaPago}</td>  
                    <td>${mantenimiento.nombre}</td>  
                    <td>${mantenimiento.DESCRIPCION}</td>  

                    <td>
                        <button class="btn btnAzul btn-dark" onclick="abrirModalEditar(${mantenimiento.idSistemaPago})">Editar</button>
                        <button class="btn btnRojo btn-dark" onclick="EliminarMantenimiento(${mantenimiento.idSistemaPago})">Eliminar</button>
                    </td>
            ...
            btnNiveles.innerText = 'Sistema de Pago Activos'
            ...
            if (mantenimiento.estado == 'I') {
                fila.innerHTML = `
                    ...
                    <td>
                        <button class="btn btnRojo btn-dark" onclick="EliminarMantenimiento(${mantenimiento.idSistemaPago})">Reactivar Sistema de Pago</button>
                    </td>
