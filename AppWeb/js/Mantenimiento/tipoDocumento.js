        ...
        if (estado == 'A') {
            ...
            btnNiveles.innerText = 'Tipo de Documento  Inactivos'
                ...
                if(mantenimiento.estado == 'A'){
                    fila.innerHTML = `
                    <td>${mantenimiento.idTipoDoc}</td>  
                    <td>${mantenimiento.nombre}</td>  
                    <td>
                        <button class="btn btnAzul btn-dark" onclick="abrirModalEditar(${mantenimiento.idTipoDoc})">Editar</button>
                        <button class="btn btnRojo btn-dark" onclick="EliminarMantenimiento(${mantenimiento.idTipoDoc})">Eliminar</button>
                    </td>
            ...
            if (mantenimiento.estado == 'I') {
                fila.innerHTML = `
                    ...
                    <td>${mantenimiento.nombre}</td>  
                    <td>
                        <button class="btn btnRojo btn-dark" onclick="EliminarMantenimiento(${mantenimiento.idTipoDoc})">Reactivar Nivel</button>
                    </td>
...
function abrirModalEditar(id) {
    ...
    console.log(id);
    const mantenimiento = datosMantenimiento.find(item => item.idTipoDoc == id);
    console.log(mantenimiento);
    if (mantenimiento) {
        document.querySelector('input[name="idTipoDoc"]').value = mantenimiento.idTipoDoc;
