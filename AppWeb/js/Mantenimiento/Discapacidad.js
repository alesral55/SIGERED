...
function generarTabla(estado) {
    ...
    Mantenimientos.forEach((mantenimiento) => {
        if (estado == 'A') {
            ...
            btnNiveles.innerText = 'Discapacidades Inactivas'

                if(mantenimiento.estado == 'A'){
                    fila.innerHTML = `
                    <td>${mantenimiento.idDiscapacidad}</td>  
                    <td>${mantenimiento.nombre}</td>  
                    <td>${mantenimiento.descripcion}</td>  

                    <td>
                        <button class="btn btnAzul btn-dark" onclick="abrirModalEditar(${mantenimiento.idDiscapacidad})">Editar</button>
                        <button class="btn btnRojo btn-dark" onclick="EliminarMantenimiento(${mantenimiento.idDiscapacidad})">Eliminar</button>
                    </td>
            ...
            btnNiveles.innerText = 'Discapacidades Activas'
            ...
            if (mantenimiento.estado == 'I') {
                fila.innerHTML = `
                    ...
                    <td>
                        <button class="btn btnRojo btn-dark" onclick="EliminarMantenimiento(${mantenimiento.idDiscapacidad})">Reactivar Discapacidad</button>
                    </td>
...
function abrirModalEditar(id) {
    ...
    console.log(id);
    const mantenimiento = datosMantenimiento.find(item => item.idDiscapacidad == id);
    console.log(mantenimiento);
    if (mantenimiento) {
        document.querySelector('input[name="idDiscapacidad"]').value = mantenimiento.idDiscapacidad;
