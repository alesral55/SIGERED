...
function generarTabla(estado) {
    ...
    Mantenimientos.forEach((mantenimiento) => {
        if (estado == 'A') {
            ...
            btnNiveles.innerText = 'Grupo Etnico  Inactivos'

                if(mantenimiento.estado == 'A'){
                    fila.innerHTML = `
                    <td>${mantenimiento.idGrupo}</td>  
                    <td>${mantenimiento.nombreGrupo}</td>  
                    <td>${mantenimiento.descripcion}</td>  

                    <td>
                        <button class="btn btnAzul btn-dark" onclick="abrirModalEditar(${mantenimiento.idGrupo})">Editar</button>
                        <button class="btn btnRojo btn-dark" onclick="EliminarMantenimiento(${mantenimiento.idGrupo})">Eliminar</button>
                    </td>
            ...
            btnNiveles.innerText = 'Grupo Etnico Activos'
            ...
            if (mantenimiento.estado == 'I') {
                fila.innerHTML = `
                    ...
                    <td>
                        <button class="btn btnRojo btn-dark" onclick="EliminarMantenimiento(${mantenimiento.idGrupo})">Reactivar Grupo Etnico</button>
                    </td>
...
function abrirModalEditar(id) {
    ...
    console.log(id);
    const mantenimiento = datosMantenimiento.find(item => item.idGrupo == id);
    console.log(mantenimiento);
    if (mantenimiento) {
        document.querySelector('input[name="idGrupo"]').value = mantenimiento.idGrupo;
        document.querySelector('input[name="nombreGrupo"]').value = mantenimiento.nombreGrupo;
        ...
        document.getElementById('tituloModal').innerText = 'Actualizar Grupo Etnico';
...
function abrirModalInsertar() {
    ...
    document.getElementById('tituloModal').innerText = 'Agregar  Grupo Etnico';
